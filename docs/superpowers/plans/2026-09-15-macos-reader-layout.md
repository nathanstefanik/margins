...
This PR supplies the development plan. The six commits below are future implementation work, not completed fixes. Inspection baseline: `3c6919c`.
...
5. Do not merge automatically. The plan PR and implementation PR are separate reviewable deliverables.
